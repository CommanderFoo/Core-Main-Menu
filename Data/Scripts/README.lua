...
The Main Menu gives creators an very simple way to create a main menu for players that shows
...
- DisableMovement
If enabled the player will not be able move until the menu is closed.
